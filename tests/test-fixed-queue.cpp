...
TEST(Cap_Container, Cap_Container_fixed_queue){
	{
		...
		ASSERT_EQ(cap_fixed_queue_capacity(fixed_queue), 5);
		ASSERT_EQ(cap_fixed_queue_size(fixed_queue), 0);
		ASSERT_EQ(cap_fixed_queue_remaining_space(fixed_queue), 5);

		int value_one = 10; // [10] [] [] [] []
		cap_fixed_queue_push(fixed_queue, &value_one);
		ASSERT_EQ(cap_fixed_queue_size(fixed_queue), 1);
		ASSERT_EQ(cap_fixed_queue_remaining_space(fixed_queue), 4);
		...
		ASSERT_EQ(cap_fixed_queue_size(fixed_queue), 2);
		ASSERT_EQ(cap_fixed_queue_remaining_space(fixed_queue), 3);
		ASSERT_EQ(*((int*)cap_fixed_queue_front(fixed_queue)), value_one);
		...
		ASSERT_TRUE((cap_fixed_queue_capacity(fixed_queue_two) == 4) && (cap_fixed_queue_size(fixed_queue_two) == 4)
				&& (cap_fixed_queue_remaining_space(fixed_queue_two) == 0));
		ASSERT_TRUE(
		...
		ASSERT_TRUE((cap_fixed_queue_capacity(fixed_queue) == 4) && (cap_fixed_queue_size(fixed_queue) == 4)
				&& (cap_fixed_queue_remaining_space(fixed_queue) == 0));
		ASSERT_TRUE((cap_fixed_queue_capacity(fixed_queue_two) == 5) && (cap_fixed_queue_size(fixed_queue_two) == 1)
				&& (cap_fixed_queue_remaining_space(fixed_queue_two) == 4));
